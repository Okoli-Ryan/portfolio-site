      ...
      <div className="services-container">
        ...
        <div className="card-container">
          ...
          <Card
            title="Weather App"
            body={Weather}
            gitLink="https://github.com/Okoli-Ryan/ReactWeather"
            siteLink="https://react-weather-temp-application.herokuapp.com"
            disabled={false}
          />
          <Card
            title="World Clock"
            body={Clock}
            gitLink="https://github.com/Okoli-Ryan/Timing"
            siteLink="https://world-clock-application.herokuapp.com"
            disabled={false}
          />
        </div>
