    ...
    <>
      ...
      <motion.div
        ...
        <div className="about-right">
          ...
          <span>UI/UX designer</span>, lover of basketball and memes, and the
          guy in the picture close to this caption ( just ignore how funny I
          look :D). I've been coding for close to a decade, moving from language
          to language before getting into web and app development in 2019. If
          you're interested and want to discuss about my work, please head over
          to the <Link to="/contact">Contact Page</Link> or check out{" "}
          <a
